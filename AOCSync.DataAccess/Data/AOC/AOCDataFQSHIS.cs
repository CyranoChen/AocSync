...
namespace AOCSync.DataAccess
{
    public class AOCDataFQSHIS
    {
        ...
        public static void InsertAOCDataFQSHIS(
                string id, string urno, string carrier_iata, string carrier_icao, string fl_number, string fl_suffix, string flt, string flr, string sdt, string sdp, string linkedfl_flt,
        ...
        {
            string sql = @"INSERT INTO [AOCFQSHIS] (
                                    [ID], [URNO], [CARRIER_IATA], [CARRIER_ICAO], [FL_NUMBER], [FL_SUFFIX], [FLT], [FLR], [SDT], [SDP], [LINKEDFL_FLT], 
                               ...
                               VALUES (
                                    @id, @urno, @carrier_iata, @carrier_icao, @fl_number, @fl_suffix, @flt, @flr, @sdt, @sdp, @linkedfl_flt, @linkedfl_carrier, @linkedfl_number, @linkedfl_suffix, @linkedfl_sdt,
